...
!function (t, e) {
    ...
    var e = "lgAfterAppendSlide", i = "lgInit", s = "lgHasVideo", n = "lgContainerResize", o = "lgUpdateSlides",
        r = "lgAfterAppendSubHtml", l = "lgBeforeOpen", a = "lgAfterOpen", g = "lgSlideItemLoad", d = "lgBeforeSlide",
        h = "lgAfterSlide", u = "lgPosterClick", c = "lgDragStart", m = "lgDragMove", p = "lgDragEnd",
        f = "lgBeforeNextSlide", v = "lgBeforePrevSlide", y = "lgBeforeClose", b = "lgAfterClose", I = {
            mode: "lg-slide",
            easing: "ease",
            speed: 400,
    ...
    var T = function (t, e, i, s) {
        ...
        if (n) {
            ...
            var g = n.split("-"), d = parseInt(g[0], 10), h = parseInt(g[1], 10), u = e.width(), c = e.height() - i,
                m = Math.min(u, d), p = Math.min(c, h), f = Math.min(m / d, p / h);
        ...
        if (n) {
            ...
            if (o.get()) {
                var r = e.get().getBoundingClientRect(), l = r.width, a = e.height() - (i + s), g = o.width(),
                    d = o.height(), h = o.style(),
        ...
        return [].forEach.call(t, (function (t) {
            ...
            var d = x(t), h = d.find("img").first().attr("alt"), u = d.attr("title"),
        ...
        return w.prototype.generateSettings = function (e) {
            ...
            if (void 0 === t && (t = this.settings.index), !this.lgOpened) {
                ...
                var o = "";
                this.mediaContainerPosition = this.getMediaContainerPosition();
                var r = this.mediaContainerPosition, g = r.top, d = r.bottom;
            ...
            var n = this, o = this.galleryItems[t], r = x(this.getSlideItemId(t)), l = o.poster, a = o.srcset,
                g = o.sizes, d = o.sources, h = o.src, u = o.video, c = u && "string" == typeof u ? JSON.parse(u) : u;
            if (o.responsive) {
                var m = o.responsive.split(",");
                h = D(m) || h
            }
            var p = o.__slideVideoInfo, f = "", v = !!o.iframe, y = !this.lGalleryOn, b = 0;
            ...
            if (this.currentItemsInDom = this.organizeSlideItems(t, o), !this.lGalleryOn || o !== t) {
                ...
                if (!this.lgBusy) {
                    ...
                    var l = this.getSlideItem(t), a = this.getSlideItem(o), g = this.galleryItems[t],
                        u = g.__slideVideoInfo;
                    if (this.outer.attr("data-lg-slide-type", this.getSlideType(g)), this.setDownloadValue(t), u) {
                        var c = this.mediaContainerPosition, m = c.top, p = c.bottom,
            ...
            if (this.zoomFromOrigin && s) {
                var n = this.mediaContainerPosition, o = n.top, r = n.bottom, l = this.galleryItems[this.index],
                    a = l.__slideVideoInfo, g = l.poster,
            ...
            var t = this, e = this.closeGallery(!0);
